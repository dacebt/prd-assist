...
- **Commit message convention:** Slice-numbered prefix. Format: `[slice-N] <imperative summary>`. Example for this slice: `[slice-1] add pnpm workspace and turbo skeleton`. The body (if any) explains the _why_ if non-obvious; otherwise omit.
